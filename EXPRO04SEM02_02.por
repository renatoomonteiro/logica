...
{
/*
4) Todos os funcionários irão receber além do seu Salário Base uma Gratificação que irá corresponder 
a 10% do seu Salário Base. 
Somados Salário Base + Gratificação teremos seu Salário Bruto. 
Será desconto o IR (Imposto de Renda) de acordo com o Salário Bruto na regra: 
Até 1.200 = 15% Acima de 1.200 = 20%
• Leia o Salário base
